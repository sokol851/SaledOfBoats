...
class Boat(models.Model):
    ...
    year = models.SmallIntegerField(**NULLABLE, verbose_name='год выпуска')
...
class BoatHistory(models.Model):
    ...
    start_year = models.SmallIntegerField(**NULLABLE, verbose_name='владел с')
    stop_year = models.SmallIntegerField(**NULLABLE, verbose_name='владел по')
